...
object GenerateUserBehaviorMonitorData {
    ...
    def main(args: Array[String]): Unit = {
        ...
        if (args.length != 1) {
            ...
            print("Usage:Please input date like 2019-04-19")
            System.exit(1)
        }
        generateMonitorData(args(0))

    }

    def generateMonitorData(date: String) = {
        ...
        val eventTime: Date = sdf.parse(date)
    ...
    def getVideoTimeAndEventTime(initTimestamp: Long, isCompleteVideo: Boolean) = {
        ...
        //事件发生事件event也统一定义为initTimestamp即可
